...
<div class="w-full  bg-white rounded-lg border border-gray-800 shadow-md dark:bg-[#1d4559] dark:border-white mx-auto my-6 ">
  <div class="flex flex-col items-center mt-0 comm:pt-6 comm:my-6">
                <Image class=" shadow-lg" src={teacher} alt="Bonnie image" width="220px" height="220px"/>
                <h5 class="my-1 text-xl font-bold text-gray-900 dark:text-white">{name}</h5>
                <span class="text-sm text-gray-200 dark:text-gray-200 font-bold">Designation</span>
