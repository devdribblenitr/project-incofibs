            ...
            <div className="grid xl:flex grid-cols-1 xl:grid-cols-2 gap-4  place-items-center content-evenly xl:w-fit xl:mx-auto 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="card">
                  ...
                  <p className="pt-10 pl-14">InCoFIBS-2023 will be held from 5th to 7th October 2023, providing a platform for global experts and researchers to exchange ideas and recent advances in the various fields of Biological Sciences</p>
                  <div >
                    <div >
