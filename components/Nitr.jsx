...
const Nitr = () => {
    ...
    <div className='mt-10 flex flex-col items-center lg:my-10'>
        ...
        <img className='center z-10 w-[400px] lg:absolute h-72 lg:h-96 rounded-3xl shadow-2xl' src="https://res.cloudinary.com/dzbax077h/image/upload/v1665156071/nitr_o5jm74.jpg" alt='nitr'/>  
        </div>
        <div className="rounded-3xl mt-10 lg:mr-[400px] m-20 lg:mb-20">
        <div className="flex flex-col space-y-4 bg-slate-100 p-5 py-20 lg:pl-20 lg:pr-44 lg:text-justify  text-center text-2xl rounded-3xl h-fit max-w-5xl shadow-xl text-[#184353dc]">
        <div className='mx-4 bg-white font-serif text-6xl text-center text-bold'>About NIT Rourkela</div><div>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Esse incidunt repudiandae eos temporibus voluptate quibusdam animi nesciunt illo consequuntur enim, aspernatur ab labore hic. Ad a fugit iure sit in?</div>
