...
const Nitr = () => {
    return (  <>
    <div className='my-20 flex flex-col items-center lg:my-10'>
        <div className='mx-4 '>
        <div className='flex flex-col items-center'>
        <img className='center z-10 w-[400px] lg:ml-[400px] lg:absolute h-72 lg:h-96 rounded-3xl shadow-[0_35px_60px_-15px_rgba(0,0,0.9,0.9)]' src="https://res.cloudinary.com/dzbax077h/image/upload/v1665156071/nitr_o5jm74.jpg" alt='incofibs'/>  
        </div>
