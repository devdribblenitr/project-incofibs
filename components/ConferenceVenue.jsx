...
const Conference = () => {
  return (
    ...
    <div className='max-w-[1440px] mx-auto grid lg:grid-cols-2 '>
      <div className= 'grid gap-x-4 gap-y-8 sm:gap-y-6 lg:gap-y-0 lg:grid-cols-2 mx-auto mt-12 '>
        <div className='lg:w-80 sm:w-3/4   mx-auto rounded-md '>
      ...
      <div className="flex flex-col py-2 xl:pt-6 mt-2 divide-y ">
