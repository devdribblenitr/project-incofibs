...
export default function EventCard() {
    return (
        <>
        <div className='grid grid-cols-1 md:grid-cols-2 bg-gray-200 rounded-lg'>
            ...
            <div className='mx-auto py-8 md:py-0 md:mr-0'>
                <img src="https://images.pexels.com/photos/12303537/pexels-photo-12303537.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" style={{height: "400px"}} className="md:rounded-r-xl" />
            </div>
        </div>
        <div>
