  ...
  return (
    <div className="flex flex-col ">
      ...
      <div className="flex justify-center w-screen">
        ...
        <div className="text-white bg-transparent text-xl sm:text-3xl lg:text-3xl ml-2 mr-2  md:ml-4  h-1/6 md:h-1/3   lg:p-6  xl:p-7 sm:p-2 sm:pl-3 sm:pr-3 lg:mr-6 border-gray-100 sm:border-2 rounded-tl-br10 rounded-br-br10 lg:rounded-tl-br25 lg:rounded-br-br25">
          <div className="flex flex-col items-center">
            <div className=" text-white flex justify-center text-md lg:text-xl xl:text-3xl font-bold mb-1">
