...
const Community = () => {
  ...
  return (
    <div className="w-full bg-white py-4 px-4">
      <div>
        <h1 className="max-w-[1440px] mx-auto text-center my-2 text-4xl text-communityColor2 font-bold">
          Our Dignitaries
        </h1>
        ...
        <div className="max-w-[802px] md:h-[350px] sm:h-[400px] mx-auto grid lg:mr-6 md:grid-cols-2  md:my-2 lg:my-4 my-4  gap-x-3 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] py-6 px-6 ">
          ...
          <div className="flex flex-col justify-center mx-auto ">
            <p className="mx-1 transition-0.4s my-4 ">
              ...
              ratione voluptates nesciunt dignissimos sit, neque, eius modi
              iusto natus nobis quo enim ab omnis sunt optio tempora consectetur
              nulla labore, dolore fugiat.{" "}
            </p>
            <h1 className="text-communityColor2 font-bold md-text-4xl sm:3xl text-2xl  mx-1">
              Name of Director
            </h1>
            <h1 className="text-communityColor2 font-bold md-text-2xl sm:xl text-lg mx-1 ">
              DIRECTOR
            </h1>
          </div>
        </div>
