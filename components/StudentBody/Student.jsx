...
const Student=()=>{
    ...
    return(
        <div className="w-full bg-[#102c3a] py-8 px-12 mx-6 ml-0">
           <div>
           <h1 className="w-full max-w-[1440px] mx-auto text-center py-2 text-4xl text-white font-bold">Core Student Body</h1>
